...
class Gen_Model():
	...
	def fit(self, states, targets, epochs, verbose, validation_split, batch_size):
		print("Fitting")
		return self.model.fit(states, targets, epochs=epochs, verbose=verbose, validation_split = validation_split, callbacks=[tensorboard] ,batch_size = batch_size)
...
class Residual_CNN(Gen_Model):
	...
	def _build_model(self):
		...
		print(self.learning_rate,config.MOMENTUM)
		model.compile(
			loss="sparse_categorical_crossentropy",
			# loss={'policy_head': softmax_cross_entropy_with_logits},
